...
import requests
import pandas as pd
import geo_coding_pipeline.Dagster_geocoding.constants as constants
...
def geocode_with_osm(generate_full_addresses: pd.DataFrame) -> pd.DataFrame:
    ...
    # Read the CSV file
    addresses_df = pd.read_csv("../geo_coding_pipeline/batch_files/usa_addresses_test_batch_1.csv")
    ...
    output_folder= "../geo_coding_pipeline/output"
